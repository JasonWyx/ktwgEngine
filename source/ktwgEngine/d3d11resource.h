...
#define DEFINE_STATIC_RESOURCE(name, type) GFX_STATIC_RESOURCE_WRAPPER_type name

#define DECLARE_STATIC_RESOURCE(name, type) extern GFX_STATIC_RESOURCE_WRAPPER_type name
